                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <ul class="list-style-none">
                                        ...
                                        <li><a href="" class="btn btn-sm btn-template-main">Lihat Promo</a></li>
                                    </ul>
                        ...
                        <?php foreach ($product as $pro) {?>
                            <div class="col-sm-4">
                                <div class="box-image">
                                    ...
                                    <div class="bg"></div>
                                    <div class="name">
                                        <h3><a href="portfolio-detail.html"><?php echo $pro['nama_barang']; ?></a></h3> 
                                    </div>
                                    <div class="text">
                                        <p class="hidden-sm"><?php echo $pro['deskripsi']; ?></p>
                                        <p class="buttons">
                                            <a href="portfolio-detail.html" class="btn btn-template-transparent-primary">View details</a>
                                            <a href="#" class="btn btn-template-transparent-primary">Add to cart</a>
                                        </p>
                                    </div>
                                </div>
                                <!-- /.box-image -->
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="box-image-text blog">
                                ...
                                <div class="top">
                                    ...
                                    <div class="text">
                                        <p class="buttons">
                                            <a href="blog-post.html" class="btn btn-template-transparent-primary"><i class="fa fa-link"></i> Tertarik</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="content">
                                    ...
                                    <p class="read-more"><a href="blog-post.html" class="btn btn-template-main">Lihat Lengkap</a>
                                    </p>
                                </div>
                            </div>
                            <!-- /.box-image-text -->
                                ...
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="" alt="" src="<?php echo base_url(); ?>assets/img/person-1.jpg">
